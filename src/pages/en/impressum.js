...
const Impressum = () => {
 ...
 const impressum = useStaticQuery(graphql`
         query {
           Anschrift: allContentfulImpressum(filter: {node_locale: {eq: "en"}, title: {eq: "Address"}}){
             edges{
               node{
                 title
                 impressum {
          ...
          Kontakt: allContentfulImpressum(filter: {node_locale: {eq: "en"}, title: {eq: "Contact"}}){
            edges{
              node{
                title
                impressum {
            ...
            Geschft: allContentfulImpressum(filter: {node_locale: {eq: "en"}, title: {eq: "Directors"}}){
              edges{
                node{
                  title
                  impressum {
            ...
            legalDetails: allContentfulImpressum(filter: {node_locale: {eq: "en"}, title: {eq: "rest"}}){
              edges{
                node{
                  impressum {
                    json
